...
if ($action == '1ans') {
    ...
    if ($role != 'RH') {
        $sql = "SELECT AGENT_MATRICULE,CONCAT(nom,' ', prenom) as NOMS, STATUT, DATE_DE_NAISSANCE,DATE_DE_NAISSANCE AS DATE_RETRAITE ,SECTION_CODE, SOA , REG_CODE FROM AGENTS";
    }else{
        $sql = "SELECT AGENT_MATRICULE,CONCAT(nom,' ', prenom) as NOMS, STATUT, DATE_DE_NAISSANCE,DATE_DE_NAISSANCE AS DATE_RETRAITE ,SECTION_CODE, SOA , REG_CODE 
