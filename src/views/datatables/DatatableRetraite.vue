    ...
    <div>
        ...
        <div class="mr-4 ml-4 mt-3 mb-3">
            <div class=" table-responsive">
                <DataTable :data="getRetraite" :columns="columns"
                    ...
                    <thead class="table-success ">
                        <tr class="toto">
                            ...
                            <th class="fw-bolder" style="font-size: 14px;">DATE DE NAISSANCE</th>
                            <th class="fw-bolder" style="font-size: 14px;">DATE DE RETRAITE</th>
...
export default {
    ...
    async setup() {
        ...
        const getRetraite =  computed(() => store.getters.getRetraite);
        const getTitre = computed(() => store.getters.getTitre)
        await new Promise(getRetraite => setTimeout(getRetraite, 4000))
        return { getRetraite, getTitre }
    }
